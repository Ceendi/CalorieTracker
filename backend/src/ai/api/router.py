...
def get_audio_service() -> AudioProcessingService:
    ...
    if _audio_service is None:
        ...
        if fineli_products:
            logger.info("Indexing products for Semantic Search Engine...")
            _audio_service.vector_engine.index_products(fineli_products)
...
@router.post(
    ...
    **Workflow:**
    ...
    3. Ingredients are matched using Hybrid Search (Vector + BM25)
