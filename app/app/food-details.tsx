                  ...
                  <View className="flex-row items-center bg-card rounded-2xl px-5 py-3 mb-6 border border-border shadow-sm gap-3">
                    <View className="flex-1">
                      <Text className="text-xs text-muted-foreground mb-0.5">
                        {t('foodDetails.gl.title')} {t('menu.optional') && ''}
                      </Text>
                      <Text className="text-base font-bold text-foreground">
                        {Math.round(gl.value)} <Text className="text-xs font-normal text-muted-foreground">({t('foodDetails.gl.ig')} {food.glycemic_index})</Text>
                      </Text>
                    </View>
                    <View className={`px-3 py-1 rounded-full ${badgeColor}`}>
                      <Text className="text-xs font-bold capitalize">{t(`foodDetails.gl.${gl.label}`)}</Text>
                    </View>
                  </View>
                );
              })()
