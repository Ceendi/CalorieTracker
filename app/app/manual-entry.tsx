...
import { ScrollView, Text, TextInput, TouchableOpacity, View, ActivityIndicator, KeyboardAvoidingView, Platform } from 'react-native';
          ...
          <View className="flex-1">
              ...
              >
                ...
                <View className="bg-card rounded-2xl p-4 mb-4 shadow-sm border border-border">
                    <Text className="text-sm font-medium text-muted-foreground mb-2">{t('manualEntry.nameLabel')}</Text>
                  ...
                  <View className="p-5">
                      ...
                      >
                          {isBusy ? (
                              ...
                              <Text className="text-primary-foreground text-lg font-bold">{t('manualEntry.save')}</Text>
                          )}
                      </TouchableOpacity>
                  </View>
                </SafeAreaView>
