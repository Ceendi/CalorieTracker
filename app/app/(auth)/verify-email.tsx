      ...
      >
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <View className="flex-1 px-6 justify-center">
            <View className="mb-8">
              <Text className="text-3xl font-bold text-gray-900 dark:text-white">{t('auth.verifyEmail')}</Text>
            ...
            >
                <Text className="text-indigo-600 dark:text-indigo-400 font-medium">{t('auth.resendCode')}</Text>
            </TouchableOpacity>
            ...
            >
                <Text className="text-gray-500 dark:text-gray-400">{t('auth.backToLogin')}</Text>
            </TouchableOpacity>
          </View>
