      ...
      >
        ...
        <LinearGradient
          colors={[
            ...
            Colors[colorScheme ?? "light"].primaryDark,
          ]}
          start={{ x: 0, y: 0 }}
          end={{ x: 1, y: 1 }}
        ...
        >
          ...
          <View className="items-center mb-4">
            <GaugeProgress
              ...
              progress={progress}
              color={
                isOverGoal ? Colors[colorScheme ?? "light"].error : "white"
              }
              trackColor="rgba(255,255,255,0.15)"
            >
              <View className="items-center justify-center">
                <Text
                  className={`text-4xl font-black tracking-tight leading-tight ${isOverGoal ? "text-destructive-light" : "text-primary-foreground"}`}
                >
                  {isOverGoal
                ...
                <Text
                  className={`text-xs font-medium uppercase tracking-widest mt-1 ${isOverGoal ? "text-destructive-light opacity-80" : "text-primary-muted"}`}
                >
          ...
          <View className="flex-row justify-around px-4 bg-indigo-950/20 rounded-2xl py-3 mx-2 border border-indigo-400/10 mb-1">
            <View className="items-center">
              <Text className="text-indigo-200 text-[10px] font-bold uppercase tracking-wider mb-0.5">
                {t("dashboard.eaten")}
              </Text>
