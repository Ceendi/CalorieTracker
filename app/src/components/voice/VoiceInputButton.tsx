    ...
    switch (state) {
      case "idle":
        return {
          icon: "mic.fill",
          color: primaryColor,
          label: t("addFood.voiceButton.record"),
        };
      case "recording":
        return {
          icon: "stop",
      ...
      case "processing":
        return {
          icon: "hourglass",
          color: warningColor,
          label: t("addFood.voiceButton.processing"),
        };
      case "success":
        return {
          icon: "checkmark",
          color: successColor,
          label: t("addFood.voiceButton.success"),
        };
      case "error":
        return {
          icon: "alert",
          color: errorColor,
          label: t("addFood.voiceButton.error"),
        };
      default:
        return {
          icon: "mic",
    ...
    <View className="items-center py-4">
      ...
      >
        <Pressable
          ...
          accessibilityHint={
            state === "idle" ? t("addFood.voiceButton.hold") : undefined
          }
          onPressIn={async () => {
